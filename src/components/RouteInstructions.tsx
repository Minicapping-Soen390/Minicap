...
import { TransportationMode } from '../MVVM/models/Route';
...
const getTransportIcon = (mode: TransportationMode, iconName: string) => {
  switch (mode) {
    ...
    case TransportationMode.WALKING:
      return <MaterialIcons name="directions-walk" size={24} color="#800000" />;
    case TransportationMode.WHEELCHAIR:
      return <FontAwesome5 name="wheelchair" size={22} color="#800000" />;
    default:
      return <MaterialIcons name="directions" size={24} color="#800000" />;
  }
};
